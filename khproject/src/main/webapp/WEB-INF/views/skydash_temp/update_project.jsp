				...
				<div class="ap1">
					<div class="ap2_0">
						<div class="ap2">
							<div class="ap3">
								<div class="ap4">
									<span class="ap5">프로젝트 / ${dto.name} / 프로젝트 설정</span>
								</div>
							</div>
							<div class="ap6">
								<div class="ap7">
									<div class="ap8">
										<h2 class="ap9">프로젝트 설정</h2>
									</div>
								</div>
								<div class="ap10">
									<div class="ap11">
										<form class="ap12" action="pjupdate.do" method="post">
											...
											<div class="ap13">
												...
												<div class="ap19"><tr>
													...
													<div class="ap21"><td><input class="ap22" type="text" name="name" id="name"
														placeholder="팀 이름" value=${dto.name }></td></div>
												</tr></div>
												<div class="ap19"><tr>
													<div class="ap20"><th>키</th></div>
													<div class="ap21"><div class="ap22"><td>${dto.no }</td></div></div>
												</tr></div>
												<div class="ap19"><tr>
													<div class="ap20"><th>프로젝트 리더</th></div>
													<div class="ap21">
														<div class="ap22" style="height: 3.0em;"><div class="ap23"><span class="face0"><img class="face" src="/resources/skydashTemp/images/faces/user_face.png"></span><span class="ap24"><td>${dto.adminName }</td></span></div></div></div>
												</tr></div>
												<div class="ap19"><tr>
