...
<head>
  ...
  <link rel="stylesheet" href="resources/adminone/dist/css/main.css?v=1628755089081">

  <link rel="apple-touch-icon" sizes="180x180" href="resources/adminone/dist/apple-touch-icon.png"/>
  <link rel="icon" type="image/png" sizes="32x32" href="resources/adminone/dist/favicon-32x32.png"/>
  <link rel="icon" type="image/png" sizes="16x16" href="resources/adminone/dist/favicon-16x16.png"/>
  <link rel="mask-icon" href="resources/adminone/dist/safari-pinned-tab.svg" color="#00b4b6"/>
    ...
    <div class="navbar-end">
      <div class="navbar-item dropdown has-divider">
        ...
        <div class="navbar-dropdown">
          <a href="resources/adminone/dist/profile.html" class="navbar-item">
...
<aside class="aside is-placed-left is-expanded">
  ...
  <div class="menu is-menu-main">
    ...
    <ul class="menu-list">
      <li class="active">
        <a href="resources/adminone/dist/index.html">
    ...
    <ul class="menu-list">
      <li class="--set-active-tables-html">
        <a href="resources/adminone/dist/tables.html">
          <span class="icon"><i class="mdi mdi-table"></i></span>
          <span class="menu-item-label">Tables</span>
        </a>
      </li>
      <li class="--set-active-forms-html">
        <a href="resources/adminone/dist/forms.html">
          <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
          <span class="menu-item-label">Forms</span>
        </a>
      </li>
      <li class="--set-active-profile-html">
        <a href="resources/adminone/dist/profile.html">
          <span class="icon"><i class="mdi mdi-account-circle"></i></span>
          <span class="menu-item-label">Profile</span>
        </a>
      </li>
      <li>
        <a href="resources/adminone/dist/login.html">
...
<script type="text/javascript" src="resources/adminone/dist/js/main.min.js?v=1628755089081"></script>

<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>
<script type="text/javascript" src="resources/adminone/dist/js/chart.sample.min.js"></script>
